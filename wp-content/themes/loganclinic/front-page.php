...
<div class="hero--home" style="background-image: url('<?php the_field("home_hero_image");?>')">
    <h1 class="hero--home_headline"><span><?php the_field('home_hero_headline');?></span></h1>
</div>
...
<div class="offset-container" style="background-image: url('<?php the_field('offset-background_image');?>')">
	<div class="container">
        <div class="content">
            <h3><?php the_field('offset-headline');?></h3>
            <?php the_field('offset-content');?>
        </div>
    </div>
</div>

<div class="about-providers container--left-image">
	<div class="container">
